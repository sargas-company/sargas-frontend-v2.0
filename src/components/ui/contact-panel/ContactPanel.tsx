			...
			{open && (
				<>
					...
					<motion.aside
						...
						animate='visible'
						exit='exit'
						className='absolute inset-x-3 top-3 z-40 h-fit overflow-hidden rounded-[28px] backdrop-blur-3xl md:inset-x-auto md:top-6 md:right-6 md:w-[820px] md:rounded-[34px]'
					>

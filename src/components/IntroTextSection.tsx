...
const IntroTextSectionWord = ({ content, index, progress }: WordProps) => {
...
export const IntroTextSection = () => {
  ...
  return (
    <div className="relative" ref={ref}>
      ...
      />
      <div className="min-h-screen flex flex-col items-center justify-center py-10 md:py-14 xl:py-20 gap-6 md:gap-7 xl:gap-0">
        <SectionTitle title="Hello!" />
        <div className="relative flex flex-col max-w-[940px] h-min pb-[280px] gap-[260px] md:py-12 md:px-[96px] md:gap-12 xl:px-[120px]">
          <p
            className="
              text-[28px] md:text-[32px] xl:text-[44px]
              leading-[1.4em]
              font-normal
              tracking-[-0.04em]
              text-center

		...
		<section className='md:pb-50 pb-20' id='process'>
			...
			<div className='place-items-center grid xs:grid-cols-1 lg:grid-cols-2 25xl:grid-cols-3 25xl:auto-rows-auto relative mb-5 box-border h-min w-full flex-wrap justify-center gap-3 overflow-visible p-0 font-sans text-[12px]'>
				...
				<motion.div
					...
					className='xs:hidden 25xl:block  25xl:col-start-1 25xl:row-start-1 lg:col-start-1 lg:row-start-1 xs:col-start-1 xs:row-start-1 relative mt-16 flex sm:h-[454px] sm:max-w-[464px] xs:h-[324px] xs:max-w-[324px] overflow-hidden rounded-2xl bg-white px-8 py-8 shadow-[0_0_0_8px_rgba(255,255,255,0.25),12px_16px_16px_rgba(0,0,0,0.1)]'
				>
				...
				<motion.div
					...
					viewport={{ once: true, amount: 0.4 }}
					className='xs:block 25xl:hidden  25xl:col-start-1 25xl:row-start-1 lg:col-start-1 lg:row-start-1 xs:col-start-1 xs:row-start-1 relative mt-16 flex lg:h-[400px] lg:max-w-[400px] sm:h-[360px] sm:max-w-[360px] xs:h-[324px] xs:max-w-[324px] overflow-hidden rounded-2xl bg-white px-8 py-8 shadow-[0_0_0_8px_rgba(255,255,255,0.25),12px_16px_16px_rgba(0,0,0,0.1)]'
				>
					<div className='flex h-full flex-col items-start justify-between gap-6'>
						<p className='text-[72px] font-light leading-[90px] tracking-[-0.06em] text-black'>
							<strong className='font-normal'>1</strong>
				...
				<motion.div
					...
					viewport={{ once: true, amount: 0.4 }}
					className='25xl:col-start-2 25xl:row-start-1 lg:col-start-2 lg:row-start-1 xs:col-start-1 xs:row-start-2 relative flex lg:h-[400px] lg:max-w-[400px] sm:h-[360px] sm:max-w-[360px] 25xl:h-[454px] 25xl:max-w-[464px] xs:h-[324px] xs:max-w-[324px] overflow-hidden rounded-2xl bg-white px-8 py-8 shadow-[0_0_0_8px_rgba(255,255,255,0.25),12px_16px_16px_rgba(0,0,0,0.1)]'
				>
					<div className='flex h-full flex-col items-start justify-between gap-6'>
						<p className='text-[72px] font-light leading-[90px] tracking-[-0.06em] text-black'>
				...
				<motion.div
					...
					viewport={{ once: true, amount: 0.4 }}
					className='xs:hidden 25xl:block 25xl:col-start-3 25xl:row-start-1 lg:col-start-1 lg:row-start-2 xs:col-start-1 xs:row-start-3 relative mt-16 flex sm:h-[454px] sm:max-w-[464px] xs:h-[324px] xs:max-w-[324px] overflow-hidden rounded-2xl bg-white px-8 py-8 shadow-[0_0_0_8px_rgba(255,255,255,0.25),12px_16px_16px_rgba(0,0,0,0.1)]'
				>
					<div className='flex h-full flex-col items-start justify-between gap-6'>
						<p className='text-[72px] font-light leading-[90px] tracking-[-0.06em] text-black'>
				...
				<motion.div
					...
					viewport={{ once: true, amount: 0.4 }}
					className='xs:block 25xl:hidden 25xl:col-start-3 25xl:row-start-1 lg:col-start-1 lg:row-start-2 xs:col-start-1 xs:row-start-3 relative mt-16 flex lg:h-[400px] lg:max-w-[400px] sm:h-[360px] sm:max-w-[360px] xs:h-[324px] xs:max-w-[324px] overflow-hidden rounded-2xl bg-white px-8 py-8 shadow-[0_0_0_8px_rgba(255,255,255,0.25),12px_16px_16px_rgba(0,0,0,0.1)]'
				>
					<div className='flex h-full flex-col items-start justify-between gap-6'>
						<p className='text-[72px] font-light leading-[90px] tracking-[-0.06em] text-black'>
							<strong className='font-normal'>3</strong>
				...
				<motion.div
					...
					viewport={{ once: true, amount: 0.4 }}
					className='xs:hidden 25xl:block 25xl:col-start-2 25xl:row-start-2 lg:col-start-2 lg:row-start-3 xs:col-start-1 xs:row-start-5  relative mt-16 flex sm:h-[454px] sm:max-w-[464px] xs:h-[324px] xs:max-w-[324px] overflow-hidden rounded-2xl bg-white px-8 py-8 shadow-[0_0_0_8px_rgba(255,255,255,0.25),12px_16px_16px_rgba(0,0,0,0.1)]'
				>
					<div className='flex h-full flex-col items-start justify-between gap-6'>
						<p className='text-[72px] font-light leading-[90px] tracking-[-0.06em] text-black'>
				...
				<motion.div
					...
					viewport={{ once: true, amount: 0.4 }}
					className='xs:block 25xl:hidden 25xl:col-start-2 25xl:row-start-2 lg:col-start-2 lg:row-start-3 xs:col-start-1 xs:row-start-5  relative mt-16 flex lg:h-[400px] lg:max-w-[400px] sm:h-[360px] sm:max-w-[360px] xs:h-[324px] xs:max-w-[324px] overflow-hidden rounded-2xl bg-white px-8 py-8 shadow-[0_0_0_8px_rgba(255,255,255,0.25),12px_16px_16px_rgba(0,0,0,0.1)]'
				>
					<div className='flex h-full flex-col items-start justify-between gap-6'>
						<p className='text-[72px] font-light leading-[90px] tracking-[-0.06em] text-black'>
							<strong className='font-normal'>5</strong>
				...
				<motion.div
					...
					viewport={{ once: true, amount: 0.4 }}
					className='xs:hidden 25xl:block 25xl:col-start-3 25xl:row-start-2 lg:col-start-2 lg:row-start-2 xs:col-start-1 xs:row-start-4 relative mt-16 flex sm:h-[454px] sm:max-w-[464px] xs:h-[324px] xs:max-w-[324px] overflow-hidden rounded-2xl bg-white px-8 py-8 shadow-[0_0_0_8px_rgba(255,255,255,0.25),12px_16px_16px_rgba(0,0,0,0.1)]'
				>
					<div className='flex h-full flex-col items-start justify-between gap-6'>
						<p className='text-[72px] font-light leading-[90px] tracking-[-0.06em] text-black'>
				...
				<motion.div
					...
					viewport={{ once: true, amount: 0.4 }}
					className='xs:block 25xl:hidden 25xl:col-start-3 25xl:row-start-2 lg:col-start-2 lg:row-start-2 xs:col-start-1 xs:row-start-4 relative mt-16 flex lg:h-[400px] lg:max-w-[400px] sm:h-[360px] sm:max-w-[360px] xs:h-[324px] xs:max-w-[324px] overflow-hidden rounded-2xl bg-white px-8 py-8 shadow-[0_0_0_8px_rgba(255,255,255,0.25),12px_16px_16px_rgba(0,0,0,0.1)]'
				>
					<div className='flex h-full flex-col items-start justify-between gap-6'>
						<p className='text-[72px] font-light leading-[90px] tracking-[-0.06em] text-black'>
							<strong className='font-normal'>4</strong>

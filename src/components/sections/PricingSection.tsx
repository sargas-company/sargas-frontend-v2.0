	...
	return (
		...
		>
			...
			<motion.div
				...
				className='relative flex flex-col flex-wrap justify-start gap-[60px] rounded-[24px] bg-white/50 p-6 shadow-[0_0_0_8px_rgba(255,255,255,0.25),12px_16px_16px_0_rgba(0,0,0,0.1)] md:p-9 lg:flex-row xl:p-[60px]'
			>
						...
						<div className='relative'>
							{isRetainer && (
								<div className='flex items-end'>
									...
									<motion.span
										className='relative z-0 ml-1 text-[32px] leading-[1.25em] tracking-[-0.06em] text-black/25 md:text-[45px] lg:text-[60px]'
							...
							<div className='flex items-end'>
								...
								<motion.span
									className='xs:ml-5 relative z-0 ml-1 text-[32px] leading-[1.25em] tracking-[-0.06em] text-black/25 sm:ml-4 md:ml-3 md:text-[45px] lg:text-[60px]'
									animate={{ x: isRetainer ? labelShiftMonthly : labelShiftCustom }}
									transition={{ type: 'spring', stiffness: 400, damping: 40 }}
								>
									{isRetainer ? '/mo' : 'from'}
							...
							{!isRetainer && (
								<div className='flex flex-wrap items-end text-lg leading-[1.5em] tracking-[-.02em] md:text-xl'>
